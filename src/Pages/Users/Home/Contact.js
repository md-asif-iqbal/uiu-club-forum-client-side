            ...
            <section class="mt-40 mb-20">
                <div class="w-9/12 mx-auto font-mono">
                    <div class="flex flex-wrap lg:justify-between -mx-4">
                        <div class="w-full lg:w-1/2 xl:w-6/12 md:px-4 px-2">
                  ...
                  "
                                ...
                                <div class="flex mb-8 max-w-[370px] justify-center w-full">
                                    <div
                                        class="
                     max-w-[60px]
                     sm:max-w-[70px]
                     ...
                     "
                                    ...
                                    <div class="w-full mx-auto">
                                        ...
                                        <p class="text-secondary">+88017623.122</p>
                                    </div>
                                </div>
                     ...
                     "
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-base text-secondary text-md">nothing@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
