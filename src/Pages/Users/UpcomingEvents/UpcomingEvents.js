                                ...
                                <div>
                                    <div className="w-6/12 mx-auto mb-28">
                                        <div className="mx-auto w-10/12 mt-10">
                                            <img className="w-80 md:w-[600px] relative mx-auto" src={item.img} alt="" />
                                            <h1 className="md:absolute  md:top-0 left-1/3 bg-[#64CEE6] w-24  py-4 text-3xl px-4 font-bold text-white font-mono text-center rounded-lg"><BiBookmarkAlt className=" text-white ml-4" /> {item.date.slice(0, 6)}</h1>
                                            <div className="font-mono absolute shadow-xl rounded-xl bg-[#4039395f] md:top-2/4 top-1/4 md:left-1/3 left-1/2 px-4 py-4 md:w-96 w-auto">
                                                ...
                                                <h1 className="text-xl mt-2 font-semibold text-white flex items-center gap-2"><BiTime /> {item.event}</h1>
                                                <h1 className="text-xl my-1 text-white flex items-center gap-2 font-semibold"><AiTwotoneCalendar /> {item.date}</h1>
                                                <h1 className="text-xl my-1 text-white flex items-center gap-2 font-semibold"><GoLocation /> {item.address}</h1>
                                                <button className="btn text-white btn-primary text-md mt-3">Details</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
